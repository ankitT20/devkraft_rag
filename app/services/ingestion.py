        ...
        try:
            ...
            try:
                ...
                cloud_success = self.storage.store_embeddings_cloud(
                    gemini_embeddings, chunks, chunk_metadata, md5_hash=md5_hash
                )
            ...
            try:
                ...
                docker_success = self.storage.store_embeddings_docker(
                    local_embeddings, chunks, chunk_metadata, md5_hash=md5_hash
                )
            except Exception as e:
    ...
    def _move_file(self, source: str, destination_folder: str):
        ...
        try:
            ...
            while dest_path.exists():
                dest_path = (
                    Path(destination_folder) / f"{source_path.stem}_{counter}{source_path.suffix}"
                )
                counter += 1
